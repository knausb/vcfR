...
For example, if we went to the grocery store and at the checkout counter we could count that we have three bananas, two oranges but zero apples when we know the store has apples.
...
We can use the function windowize.NM to windowize our data and perform several forms of summary for each of these windows.

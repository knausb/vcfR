...
vcfR is a package intended to help researchers view, understand and filter data in vcf format files.
...
chromodot(pinf_mt, x1=x1, y1=y1, label1="Simulated data", dot.alpha="ff")
```
...
These last functions were recently developed and have yet to be integrated with Chrom objects.

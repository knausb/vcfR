---
title: "Converting vcfR to other forms"
...
This appears to be due  a call to the function adegenet::df2genind and will hopefully be addressed by its authors in the future (adegenet was produced prior to high throughput sequencing).
...
Variant callers such as FreeBayes and the GATK's haplotype caller currently support more than two alleles per locus, making the genlight object a suboptimal container than the genind object.
However, the trade off is that the genlight object is much more efficient to use than the genind object.
These loci with more than two alleles will be omitted from the genlight object.

...
```{r ape::image.DNAbin, fig.align='center', fig.width=7, fig.height=7}
par(mar=c(5,8,4,2))
...
```{r ape::image.DNAbin 2, fig.align='center', fig.width=7, fig.height=7}
par(mar=c(5,8,4,2))
ape::image.DNAbin(my_dnabin1[,ape::seg.sites(my_dnabin1)])
par(mar=c(5,4,4,2))
```

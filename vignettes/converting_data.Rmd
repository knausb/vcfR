...
The warning is because our example dataset has uninteresting locus names.
...
Variant callers such as FreeBayes and the GATK's haplotype caller currently support more than two alleles per locus, so vcfR2genelight currently omits loci which include more than two alleles.
However, the genlight object is much more efficient to use than the genind object as it was designed with high throughput sequencing in mind.

...
pinf_mt <- proc_chrom(pinf_mt, verbose=FALSE, win.size=3e3)
```
...
```{r, fig.height=7, fig.width=7}
plot(pinf_mt@var.info$DP, pinf_mt@var.info$MQ, col="#0000ff66")
```
...
```{r}
cor(pinf_mt@var.info$DP, pinf_mt@var.info$MQ)
```

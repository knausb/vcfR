...
if( require(reshape2) & require(ggplot2) & require(scales) ){
  ...
  p <- p + scale_y_continuous(trans=log2_trans(), breaks=c(1, 10, 100, 800))
  p
} else {
  message("The packages reshape2, ggplot2 and scales are required for this example but do not appear
